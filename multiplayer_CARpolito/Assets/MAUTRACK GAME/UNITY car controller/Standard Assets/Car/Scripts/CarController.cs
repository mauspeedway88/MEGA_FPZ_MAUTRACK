...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        private float maxSpeed = 0.0f; // The maximum speed of the target ** IN KM/H **

        [Header("UI")]
        public Text speedLabel; // The label that displays the speed;
        public Text speedLabel2; // The label that displays the speed;
    ...
    private void Update()
    {
        ...
        speed = target.linearVelocity.magnitude * 2.237f;
            if (speedLabel != null)
            {
                speedLabel.text = ((int)speed) + " ";
                speedLabel2.text = ((int)speed) + " ";
            }
           
                //FillImage.fillAmount =  speed / m_Topspeed;
                FillImage.fillAmount = speed / originalSpeed;
         
            // print("target.velocity.magnitude" + target.velocity.magnitude);
    } 

        // Use this for initialization
        private void Start()
        {
            originalSpeed = m_Topspeed;
            maxSpeed = m_Topspeed;
        ...
        public void CapSpeed()
        {
            ...
            switch (m_SpeedType)
            {
                case SpeedType.MPH:
                    ...
                    speed *= 2.23693629f*speedChangeFactor; // changes made here
                    //speed = (speed + speedChangeFactor) * 2.23693629f;
                    //if (changeSpeed)
                    //{
                    //    changeSpeed = false;
                    //    speed = speed + speedChangeFactor;
                    //}
                    if (speed > m_Topspeed)
